...
public class ScriptExecutionManager {
    ...
    void createScriptScanner(String fileName) throws CommandArgumentException, FileNotFoundException {
    ...
    private void validateScript(File scriptFile) throws CommandArgumentException, FileNotFoundException {
